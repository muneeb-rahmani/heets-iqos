...
export async function generateMetadata(props) {
  const data = await getCategoryMetadata('umm-al-quwain');
...
const Page = async () => {
  ...
  const metaData = await getCategoryMetadata('umm-al-quwain');
  return (
    <>
      <UmmAlQuwain productData={data} metaData={metaData} />
      <script
