    ...
    jsonld: [
      {
        ...
        address: {
          ...
          addressLocality:
            "27 Street 56B - Al Barsha - Al Barsha 3 - Dubai - United Arab Emirates",
          addressRegion: "UAE",
          streetAddress:
            "27 Street 56B - Al Barsha - Al Barsha 3 - Dubai - United Arab Emirates",
        },
        areaServed: "UAE",
        image:
          "https://heetsiqosuae.ae/assets/front/images/trusted-IQOS-Heets-Online-Seller-in-Dubai-UAE.webp",
        logo: "https://heetsiqosuae.ae/assets/front/images/heets-iqos-uae-logo.png",
        name: "Heets IQOS UAE",
        openingHours: ["Mo-Su 03:00-23:00"],
      ...
      },
      {
        ...
        description:
          "Buy IQOS Heets online in Dubai from the #1 trusted store in UAE. Enjoy 20% discount, instant 1 hour delivery, and a wide range of premium heets and terea flavors. Shop now!",
        inLanguage: "en",
        potentialAction: [
          {
            "@type": "ReadAction",
            target: ["https://heetsiqosuae.ae/"],
          },
        ],
      },
    ],
