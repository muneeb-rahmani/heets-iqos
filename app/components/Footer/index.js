          ...
          <div>
            ...
            <ul className="space-y-2">
              {quickLinks.map((link, index) => (
                <li key={index}>
                  <Link prefetch={false} href={link?.link} className="hover:text-gray-300 transition-colors">
                    {link?.name}
                  </Link>
                </li>
              ))}
          ...
          <div>
            ...
            <ul className="space-y-2">
              {deliveryLocations.map((location,index) => (
                <li key={index}>
                  <Link prefetch={false} href={location.url} className="hover:text-gray-300 transition-colors">
                    {location.name}
                  </Link>
                </li>
              ))}
        ...
        <div className="mt-12 pt-8 border-t border-gray-800">
          <div className="text-center">
            ...
            <div className="flex justify-center space-x-4">
              <Link prefetch={false} href="#" className="hover:opacity-80 transition-opacity" aria-label="Heets IQOS UAE Youtube Link">
              ...
              <Link prefetch={false} href="#" className="hover:opacity-80 transition-opacity" aria-label="Heets IQOS UAE Instagram Link">
              ...
              <Link prefetch={false} href="#" className="hover:opacity-80 transition-opacity" aria-label="Heets IQOS UAE Facebook Link">
              ...
              <Link prefetch={false} href="#" className="hover:opacity-80 transition-opacity" aria-label="Heets IQOS UAE Pinterest Link">
