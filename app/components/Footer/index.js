        ...
        <div className="mt-12 pt-8 border-t border-gray-800">
          <div className="text-center">
            ...
            <div className="flex justify-center space-x-4">
              <Link href="#" className="hover:opacity-80 transition-opacity" aria-label="Heets IQOS UAE Youtube Link">
              ...
              <Link href="#" className="hover:opacity-80 transition-opacity" aria-label="Heets IQOS UAE Instagram Link">
              ...
              <Link href="#" className="hover:opacity-80 transition-opacity" aria-label="Heets IQOS UAE Facebook Link">
              ...
              <Link href="#" className="hover:opacity-80 transition-opacity" aria-label="Heets IQOS UAE Pinterest Link">
